...
-- ============ NOTIFICATIONS ============
-- Stores alerts generated by background monitors (injury changes,
-- matchup insights, etc.).  Read by the desktop bell widget and
-- the web notification panel.
