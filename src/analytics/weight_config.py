...
OPTIMIZER_RANGES = {
    ...
    "fatigue_b2b": (0.0, 10.0),               # sweep: ML ROI/Win% best at ~7.5-8.0, was capped at 5.0
    "fatigue_3in4": (0.0, 10.0),              # 3-in-4 nights penalty; CD finds ~5.0, binary flag so max=8pts
