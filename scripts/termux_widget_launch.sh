...
#   ln -sf ~/trytry/scripts/termux_widget_launch.sh ~/.shortcuts/Basketball-Analytics
#
# Then add the Termux:Widget to your home screen and select "Basketball-Analytics"
